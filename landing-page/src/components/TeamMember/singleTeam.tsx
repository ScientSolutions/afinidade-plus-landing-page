            ...
            <div className="team-single-text">
              ...
              <div className="text-content mt-20">
                ...
                <p>
                  ...
                  process improvements. Competently scale transparent methods of
                  empowerment and visionary products.
                </p>
              </div>
            ...
            <ul className="list-unstyled">
              ...
              <li className="py-2">
                <div className="d-flex align-items-center">
                  ...
                  <div>
                    <p className="mb-0">
                      Good Business Consultants are Willing to Travel Where the
                      Work Is
                    </p>
                  </div>
                </div>
