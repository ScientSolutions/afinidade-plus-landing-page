            ...
            <div className="testimonial-quote-wrap my-lg-3 my-md-3 rounded white-bg shadow-sm p-5">
              <div className="client-say">
                <p>
                  ...
                  extensive initiatives. Conveniently grow innovative benefits
                  through fully tested deliverables. Rapidiously utilize focused
                  platforms through end-to-end schemas.
                </p>
              </div>
